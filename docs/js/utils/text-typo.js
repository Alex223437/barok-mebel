// чистим пробелы/переносы и склеиваем короткие союзы с последующим словом
const BAD_WS   = /[\u00ad\u200b\u200c\u200d\u2028\u2029\u2060\uFEFF]/gu;
const MULTI_WS = /\s{2,}/g;
const GLUE_WORDS = ['и','а','но','в','к','с','у','о','от','по','на','за','из','без','для','над','под','при','об','обо','со','ко'];
